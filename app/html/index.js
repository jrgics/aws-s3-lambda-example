$(document).ready(() => {
    ...
    $('#echo').click(event => {
        ...
        // Send the AJAX request
        doGet(`https://fq6kxryc23.execute-api.us-west-2.amazonaws.com/default/echo?message=${message}`);
    });
    ...
    $('#reverse').click(event => {
        ...
        // Send the AJAX request
        doGet(`https://swfqbizvq7.execute-api.us-west-2.amazonaws.com/default/reverse?message=${message}`);
    });
    ...
    $('#uppercase').click(event => {
        ...
        // Send the AJAX request
        doGet(`https://j4xdtkvfo6.execute-api.us-west-2.amazonaws.com/default/uppercase?message=${message}`);
    });
